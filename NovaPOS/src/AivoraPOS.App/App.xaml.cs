...
using AivoraPOS.App.Logging;
using AivoraPOS.App.Services;
using AivoraPOS.App.ViewModels;
using AivoraPOS.App.ViewModels.Login;
using AivoraPOS.App.ViewModels.Products;
using AivoraPOS.App.ViewModels.Reports;
using AivoraPOS.App.ViewModels.Sales;
using AivoraPOS.App.ViewModels.Settings;
using AivoraPOS.App.ViewModels.Shell;
using AivoraPOS.App.ViewModels.Users;
using AivoraPOS.App.Views;
using AivoraPOS.App.Views.Login;
using AivoraPOS.App.Views.Splash;
...
using AivoraPOS.Data.Extensions;
using AivoraPOS.Licensing.Extensions;
using AivoraPOS.Reporting.Extensions;
using AivoraPOS.Security.Extensions;
using Serilog;
using Serilog.Core;
...
public partial class App : Application
{
    ...
    protected override async void OnStartup(StartupEventArgs e)
    {
        ...
        Log.Logger = new LoggerConfiguration()
            ...
            .WriteTo.File(
                Path.Combine(AppPaths.LogsDirectory, "aivorapos-.log"),
    ...
    {
        services.AddAivoraPOSSecurity();
        services.AddAivoraPOSData();
        services.AddAivoraPOSLicensing();
        services.AddAivoraPOSReporting();
