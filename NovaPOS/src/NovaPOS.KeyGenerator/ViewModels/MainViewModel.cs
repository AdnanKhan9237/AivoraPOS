...
namespace NovaPOS.KeyGenerator.ViewModels;
...
public partial class MainViewModel : ObservableObject
{
    ...
    private async Task GenerateAsync()
    {
        ...
        {
            MessageBox.Show("Customer name is required.", "NovaPOS Key Generator", MessageBoxButton.OK, MessageBoxImage.Warning);
            return;
        }

        if (ExpiryDate is null)
        {
            MessageBox.Show("Expiry date is required.", "NovaPOS Key Generator", MessageBoxButton.OK, MessageBoxImage.Warning);
            return;
        }
